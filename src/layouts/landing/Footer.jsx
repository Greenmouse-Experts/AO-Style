...
const Footer = () => {
  ...
  return (
    <footer
      className="relative text-white jus bg-cover bg-bottom"
      style={{
        backgroundImage:
    ...
    >
      <div className="Resizer mx-auto px-6 grid md:grid-cols-6 gap-4 text-sm">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-6">
            <li>
              <Link
                to="/"
                className="hover:underline text-[#C5C5C5] font-light"
              >
                Home
              </Link>
            </li>
        ...
        <div className="col-span-2">
          ...
          <ul className="space-y-6">
            ...
            <p className="flex items-center gap-2 text-[#C5C5C5] font-light">
              <FaMapMarkerAlt /> 13 Road 101, Efab Sunshine Estate, Waru, Apo,
              FCT Abuja, Nigeria
            </p>
            <p className="flex items-center gap-2 text-[#C5C5C5] font-light">
              <FaClock />
              Office hours: Mon – Friday: 8am – 5pm, Sat: 10am – 2pm{" "}
            </p>
          </ul>
        </div>
      ...
      <div className="text-center text-xs mt-10 pb-2 border-t pt-5">
        © {new Date().getFullYear()} CARYBIN LIMITED. All rights reserved.
      </div>
    </footer>
  );
};
