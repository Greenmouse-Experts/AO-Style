      ...
      <div className="Resizer">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-grow justify-left space-x-4 lg:space-x-6 xl:space-x-12">
            {["Home", "About", "Shop", "Marketplace", "FAQs"].map((item) => (
              <a key={item} href="#" className="text-gray-800 hover:text-purple-500 transition">
                {item}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            <button className="bg-gradient text-white px-5 lg:px-6 py-2 lg:py-3 hover:bg-purple-600 transition">
              Get Started
            </button>
          </div>
      ...
      >
        <div className="p-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="relative">
              <button
                className="flex items-center justify-between w-full text-gray-800 hover:text-purple-500 transition py-2"
