        ...
        <div className="min-h-screen flex items-center justify-center Resizer">
            <div className="w-full flex overflow-hidden">
                ...
                <div className="w-full md:w-1/2 p-4 sm:p-8">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Sign Up As A <span className="text-[#2B21E5]">Fabric Vendor</span></h2>
                    ...
                    <div className="flex mt-4 border-b border-[#D86BC3]">
                        <button className={`flex-1 pb-2 text-center ${step === 1 ? 'border-b-3 border-[#D86BC3] font-medium cursor-pointer' : 'text-gray-500'}`} onClick={() => setStep(1)}>Personal Details</button>
                        <button className={`flex-1 pb-2 text-center ${step === 2 ? 'border-b-3 border-[#D86BC3] font-medium cursor-pointer' : 'text-gray-500'}`} onClick={() => setStep(2)}>Business Details</button>
                    </div>
                        ...
                        <form className="mt-6 space-y-4">
                            {step === 1 ? (
                                ...
                                <>
                                    ...
                                    <input type="text" placeholder="Enter your business registration number" className="w-full p-4 border border-[#CCCCCC] outline-none  mb-3 rounded-lg" required />

                                    <button type="button" className="text-purple-600 font-semibold mt-3 cursor-pointer" onClick={() => setStep(1)}>Back</button>
                                    <button type="button" className="w-full bg-gradient text-white py-4 rounded-lg font-meduim cursor-pointer" onClick={() => setStep(2)}>
