...
const Privacy = () => {
  ...
  const internationalTransfers = {
    description:
      "We may transfer your personal data to locations in another country, if this is permissible pursuant to applicable laws in your location. These are relevant risks in such transfers.",
    points: [
  ...
  const legalRights = {
    description:
      "All it is important that the personal data we hold about you is accurate and current. Please keep us informed if your personal data changes during your relationship with us.",
    points: [
  ...
  const dataControllers = {
    description:
      "If you have any questions or concerns about Oasiyahs Privacy Notice or you are looking for more information on how we process your personal data, or wish to exercise your legal rights in respect of your personal data, please contact the Data Privacy Officer by email at  info@carybin.com.",
    points: [
          ...
          <div className="">
            <div className="mt-14 mb-8">
              <p className="text-black text-base leading-loose mb-16">
                This Privacy Notice provides information on how Carybin collects
            ...
            <div className="mb-8">
              ...
              {dataCollection.map((item, index) => (
                <p key={index} className="text-black mb-2 leading-loose">
                  - {item.description}
                </p>
              ))}
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-black mb-2 leading-loose">
                {internationalTransfers.description}
              </p>
              <ul className="list-disc pl-5">
                {internationalTransfers.points.map((point, index) => (
                  <li key={index} className="text-black mb-2 leading-loose">
                    {point}
                  </li>
                ))}
              </ul>
