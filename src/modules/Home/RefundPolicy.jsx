                ...
                <div className="w-full flex flex-col xl:px-40 lg:pl-20 lg:pr-36 md:px-20 px-5 py-3 lg:gap-10 md:gap-8 gap-5 h-full bg-white">
                    <header className="mt-10">
                        <p className="text-base mb-6 leading-loose">
                            At Carybin ltd, we want you to have a positive experience every time you shop with us. Occasionally though, we know you
                            may want to return items you have purchased. This Returns Refunds Policy sets out our conditions for accepting returns
                            and issuing refunds for items purchased on OAstyles on behalf of our sellers. It also sets out when we will not accept
                    ...
                    <section className="">
                        ...
                        <p className="mb-4 leading-loose">
                            ...
                            You may return items purchased on OAstyles within the returns period, for the reasons listed below:
                        </p>
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="bg-gray-50">
                                        <th className="p-4 text-left border-b border-gray-300">Reason for Return</th>
                                        <th className="p-4 text-left border-b border-gray-300">Applicable Product Category</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <section className="">
                        ...
                        <p className="mb-4 leading-loose">
                            ...
                            became damaged or defective after reasonable use.
                        </p>
                    </section>
