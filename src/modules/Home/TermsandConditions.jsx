...
const TermsAndConditions = () => {
  ...
  const registration = [
    {
      title: "2.1",
      content:
        "You may not register with our marketplace if you are under its years of age (by using our marketplace or agreeing to these general terms and conditions you warrant and represent us us that you are at least 18 years of age).",
    },
    {
      title: "2.2",
      content:
  ...
  const termsOfSale = [
    ...
    },
    {
      title: "3.2",
      content:
        "Subject to these general terms and conditions the sellers' terms of business shall govern the contract for sale and purchase between the buyer and the seller. Notwithstanding this the following provisions will be incorporated into the contract of sale and purchase between the buyer and the seller:",
      subItems: [
  ...
  const returnsRefunds = [
    ...
    },
    {
      title: "4.2",
      content:
        "Refunds in respect of returned products shall be managed in accordance with the refunds page on the marketplace as may be amended from time to time. Our rates on refunds shall be exercised in our discretion subject to applicable laws of the territory. We may offer refunds in our discretion:",
      subItems: [
  ...
  const contentRights = [
    ...
    },
    {
      title: "5.2",
      content:
        "You grant to us the right to sub-license the rights licensed under section 8.1",
    },
    {
      title: "5.3",
      content:
        "You grant to us the right to bring an action for infringement of the rights licensed under section 8.1",
    },
    {
      title: "5.4",
      content:
  ...
  const websiteUse = [
    {
      title: "6.1",
      content:
        "In this section the words 'marketplace' and 'website' shall be used interchangeably to refer to oasiyle websites and mobile applications.",
    },
    {
      title: "6.2",
      content: "You may:",
    ...
    },
    {
      title: "6.3",
      content:
        "Except as expressly permitted by section 10.2 or the other provisions of these general terms and conditions you must not download any material from our website or save any such material to your computer.",
    },
    {
      title: "6.4",
      content:
    ...
    },
    {
      title: "6.7",
      content:
        "Notwithstanding section 10.6 you may forward links to products on our website and redistribute our newsletter and promotional materials in print and electronic form to any person.",
    },
    {
      title: "6.8",
      content:
  ...
  const copyrightTrademarks = [
    ...
    },
    {
      title: "7.2",
      content:
        "Oasiyle's logos and our other registered and unregistered trademarks are trademarks belonging to us; we give no permission for the use of these trademarks and such use may constitute an infringement of our rights.",
    },
    {
      title: "7.3",
      content:
  ...
  const dataPrivacy = [
    {
      title: "8.1",
      content:
        "Buyers agree to processing of their personal data in accordance with the terms of Cabrybin Limited/oasiyle's Privacy and Cookie Notice.",
    },
    {
      title: "8.2",
      content:
        "Carybin shall process all personal data obtained through the marketplace and related services in accordance with the terms of our Privacy and Cookie Notice and Privacy Policy.",
    },
    {
      title: "8.3",
      content:
        "Sellers shall be directly responsible to buyers for any misuse of their personal data and Carybin shall bear no liability to buyers in respect of any misuse by sellers of their personal data.",
    },
  ];
  const dueDiligence = [
    {
  ...
  const marketplaceRole = [
    ...
    },
    {
      title: "10.2",
      content:
        "We commit to ensure that Carybin or third party sellers as applicable submit information relating to their products on the marketplace that is complete accurate and up to date and pursuant thereto;",
      subItems: [
  ...
  const liabilityLimitations = [
    ...
    },
    {
      title: "11.2",
      content:
        "The limitations and exclusions of liability set out in this section 15 and elsewhere in these general terms and conditions:",
      subItems: [
    ...
    },
    {
      title: "11.5",
      content:
        "Notwithstanding section 15.4 above we will not be liable to you for any loss or damage of any nature including in respect of:",
      subItems: [
  ...
  const breaches = [
    ...
    },
    {
      title: "13.2",
      content:
        "If you breach these general terms and conditions or if we reasonably suspect that you have breached these general terms and conditions or any Carybin codes, policies or guidelines in any way we may:",
      subItems: [
  ...
  const variation = [
    {
      title: "15.1",
      content:
        "We may revise these general terms and conditions the seller terms and conditions and the carybin codes, policies and guidelines from time to time.",
    },
    {
      title: "15.2",
      content:
  ...
  const lawJurisdiction = [
    {
      title: "20.1",
      content:
        "These general terms and conditions shall be governed by and construed in accordance with the laws of the Federal Republic of Nigeria.",
    },
    {
      title: "20.2",
      content:
        "Any disputes relating to these general terms and conditions shall be subject to the exclusive jurisdiction of the courts of Nigeria.",
    },
  ];
  ...
  const contentRules = [
    ...
    },
    {
      title: "21.4",
      content:
        "Your content must not be illegal or unlawfully infringe any person's legal rights or be capable of giving rise to legal action against any person (in each case in any jurisdiction and under any applicable law). Your content must not infringe or breach:",
      subItems: [
    ...
    },
    {
      title: "21.11",
      content:
        "If you learn of any unlawful material or activity on our marketplace or any material or activity that breaches these general terms and conditions, you may inform us by contacting us as provided at section 22.",
    },
  ];
  ...
  const companyDetails = [
    {
      title: "22.1",
      content:
        "You can contact us by using the contact details on the website or incorporation documents as can be viewed on the Corporate Affairs Commission website.",
    },
    {
      title: "22.2",
      content:
        "You may contact our sellers for after-sales queries including any disputes by requesting their contact details from us in accordance with the Dispute Resolution Policy pursuant to which Carybin shall be obliged to ensure that the seller is clearly identifiable.",
    },
    {
      title: "22.3",
      content:
        ...
        <div className="w-full flex flex-col xl:px-40 lg:pl-20 lg:pr-36 md:px-20 px-5 py-3 lg:gap-10 md:gap-8 gap-5 h-full bg-white">
          <div className="mt-14 mb-8">
            <h1 className="text-lg font-bold text-center text-black mb-8">
              General Terms and Conditions of Use of the oasiyes Marketplace for
              Buyers and Sellers
            </h1>
                  ...
                  {item.subItems && (
                    <ul className="list-disc pl-5">
                      {item.subItems.map((subItem, subIndex) => (
                        <li
                          key={subIndex}
                          className="text-black mb-2 leading-loose"
                        >
                          {subItem}
                        </li>
                      ))}
            ...
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-center text-black bg-[#FFEAFF] py-4 mb-4">
                10. Carybin's role as a marketplace
              </h2>
