        ...
        <>
            <section className="Resizer section px-4">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center text-left mb-6">
                    <div>
                        <h2 className="text-2xl font-medium max-w-md leading-relaxed">Pick a style to sew your fabric</h2>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {sortedProducts.map((product) => (
                        ...
                        >
                            ...
                            <p className="text-[#2B21E5] text-left font-light">{product.price} <span className="text-[#8A8A8A] font-medium">per units</span></p>
                        </Link>
                    ))}
                </div>
