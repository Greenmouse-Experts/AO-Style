...
import { FaTimes, FaUpload, FaUser, FaEnvelope, FaPhone, FaFileAlt, FaCheckCircle } from 'react-icons/fa';
        ...
        try {
            ...
            uploadDocument(uploadFormData, {
                onSuccess: (uploadResponse) => {
                    ...
                    const documentUrl = uploadResponse?.data?.data?.url || uploadResponse?.data?.url || uploadResponse?.url;
                        ...
                        {isSubmitted ? (
                            ...
                            <div className="p-8 text-center">
                                ...
                                <p className="text-gray-600 mb-4">
                                    Thank you for applying to <span className="font-semibold text-purple-600">{job.title}</span>. 
