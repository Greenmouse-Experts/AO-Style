...
const Features = () => {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-2 md:grid-rows-2 lg:flex lg:flex-row items-center justify-center gap-6 px-4 py-6 Resizer">
      {features.map((feature, index) => (
        <div
          key={index}
          className="flex flex-col md:flex-row items-center text-center md:text-left bg-white p-6 rounded-lg w-full sm:w-[80%] md:w-full lg:w-[30%]"
        >
