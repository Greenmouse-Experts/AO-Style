        ...
        <section className="Resizer section px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              {isShareModalOpen && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-50 animate-fade-in-up">
                  <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4 shadow-2xl">
                    ...
                    {productVal && (
                      <div className="flex items-center bg-gray-50 rounded-lg p-3 mb-6">
                        <img
                          src={
                            productVal?.photos?.[0] || "/placeholder-image.jpg"
                          }
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-center bg-gray-50 rounded-lg p-3 border">
                        ...
                        <button
                          ...
                          className="ml-2 px-4 py-2 bg-purple-600 text-white text-sm rounded-lg hover:bg-purple-700 transition-colors font-medium"
                        >
                          Copy Link
                        </button>
                      </div>
