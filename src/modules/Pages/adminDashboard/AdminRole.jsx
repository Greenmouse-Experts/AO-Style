            ...
            {isModalOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="text-lg font-semibold mb-6 -mt-7">Add New Admin Roles</h3>
                        <div className="space-y-6">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-4">Admin Role Name</label>
                                <input
                                    type="text"
                                    name="roleName"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-4">Roles Assigned</label>
                                <div className="space-y-4">
                                    <label className="flex items-center text-sm text-gray-700">
                                        <input
                                            type="checkbox"
                                            value="Fabric Vendor Dashboard"
                                            checked={newRole.assignedRoles.includes("Fabric Vendor Dashboard")}
                                    ...
                                    <label className="flex items-center text-sm text-gray-700">
                                        <input
                                            ...
                                            checked={newRole.assignedRoles.includes("Customer Dashboard")}
                                            onChange={handleCheckboxChange}
                                            className="mr-2"
                                        />
                                        Customer Dashboard
                                    ...
                                    <label className="flex items-center text-sm text-gray-700">
                                        <input
                                            ...
                                            checked={newRole.assignedRoles.includes("Tailor/Designer Dashboard")}
                                            onChange={handleCheckboxChange}
                                            className="mr-2"
                                        />
                                    ...
                                    <label className="flex items-center text-sm text-gray-700">
                                        <input
                                            ...
                                            checked={newRole.assignedRoles.includes("Market Rep Dashboard")}
                                            onChange={handleCheckboxChange}
                                            className="mr-2"
                                        />
