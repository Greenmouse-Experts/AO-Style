                ...
                <div className="bg-white p-6 rounded-lg w-[90%] sm:w-[400px]">
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <input type="text" className="w-full p-3 mt-3 border border-[#CCCCCC] outline-none rounded-lg" placeholder="Customer Name" />
                        </div>

                        <div>
                            <label className="text-sm text-gray-600">Customer Email</label>
                            <input type="email" className="w-full p-3 mt-3 border border-[#CCCCCC] outline-none rounded-lg" placeholder="Customer Email" />
                        </div>
                        ...
                        {addAddress && (
                            <div className="space-y-3">
                                <div>
                                    <label className="text-sm text-gray-600">Building No., Street Address</label>
                                    <input type="text" className="w-full p-3 mt-3 border border-[#CCCCCC] outline-none rounded-lg" placeholder="Building No., Street Address" />
                                </div>
                                <div>
                                    <label className="text-sm text-gray-600">City</label>
                                    <input type="text" className="w-full p-3 mt-3 border border-[#CCCCCC] outline-none rounded-lg" placeholder="City" />
                                </div>
                                <div className="flex gap-2">
