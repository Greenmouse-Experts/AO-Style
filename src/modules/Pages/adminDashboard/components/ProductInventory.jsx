      ...
      <div className="bg-gradient p-6 rounded-2xl text-white">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2">
            <Folder
              size={24}
              className="bg-white p-1 rounded-md text-[#5B21B6]"
            />
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-2xl font-semibold">{userData?.totalProducts}</p>
          </div>
          <div>
            <p className="text-sm text-gray-200 mb-4">Total Sales</p>
            <p className="text-2xl font-semibold flex items-center">
              {userData?.totalSales}{" "}
              {/* <span className="text-green-400 text-sm ml-2">+24%</span> */}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2">
            <ShoppingCart
              size={24}
              className="bg-yellow-100 p-1 rounded-md text-black"
            />
          </div>
        ...
        <div className="flex justify-between">
          ...
          <div>
            ...
            <p className="text-2xl font-semibold">{userData?.totalCustomers}</p>
          </div>
        </div>
      </div>
    </div>
