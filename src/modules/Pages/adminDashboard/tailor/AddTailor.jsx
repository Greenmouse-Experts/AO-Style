...
const AddTailorForm = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-xl overflow-x-auto">
            <h2 className="text-lg font-semibold mb-6">Add Tailor/Fashion Designers</h2>

            {/* Tabs */}
            <div className="flex space-x-6 border-b border-gray-300 mb-6">
                <button
                    onClick={() => setActiveTab('personal')}
                    className={`py-2 px-4 ${activeTab === 'personal' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500'}`}
                >
                    Personal Info
                </button>
                <button
                    onClick={() => setActiveTab('business')}
                    className={`py-2 px-4 ${activeTab === 'business' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500'}`}
                >
                    Business Info
                </button>
                <button
                    onClick={() => setActiveTab('kyc')}
                    className={`py-2 px-4 ${activeTab === 'kyc' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500'}`}
                >
                    KYC
                </button>
            </div>
                ...
                <div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="col-span-1">
                            <label className="block text-gray-700 mb-4">Profile Picture</label>
            ...
            {activeTab === 'business' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="block text-gray-700 mb-4">Business Registration Number (Optional)</label>
                        <input
                            type="text"
            ...
            <div className="mt-8 flex justify-between">
                ...
                >
                    {activeTab === 'kyc' ? 'Submit' : activeTab === 'business' ? 'Proceed to KYC' : 'Proceed to Business Info'}
                </button>
            </div>
