...
const CustomersTable = () => {
  ...
  // Query for pending tailor invites
  ...
  return (
    <div className="bg-white p-6 rounded-xl overflow-x-auto">
      ...
      {activeTab === "table" ? (
        <>
          {!isLoading && (currView === "registered" ? TailorData : InviteData).length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 px-4">
              ...
              <h3 className="text-lg font-semibold text-gray-700 mb-2">
                No Tailors/Designers Found
              </h3>
              <p className="text-sm text-gray-500 text-center max-w-md">
                {queryString
                  ? `No tailors/designers match your search "${queryString}"`
                  : activeFilters.length > 0
                    ? "No tailors/designers match the selected date filters. Try adjusting your filters."
                    : currView === "registered"
                      ? "There are no registered tailors/designers at the moment."
                      : currView === "pending"
                        ? "There are no pending tailor/designer invites."
                        : currView === "rejected"
                          ? "There are no expired tailor/designer invites."
                          : "There are no tailor/designer invites."}
              </p>
