...
import { FaBullhorn, FaCalendarAlt, FaClock, FaEye, FaArrowLeft } from "react-icons/fa";
...
const CustomerAnnouncementsPage = () => {
    ...
    console.log("Customer Announcements - Nested Data:", announcementsData?.data?.data);
    ...
    if (announcementsData) {
        ...
        } else if (announcementsData.data?.data && Array.isArray(announcementsData.data.data)) {
...
export default CustomerAnnouncementsPage;
