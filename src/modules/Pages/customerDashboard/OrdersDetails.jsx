...
import { CheckCircle, Circle, Phone, MessageSquare, Mail, FileText, X } from "lucide-react";
                ...
                <div className="bg-white p-6 rounded-md md:col-span-2">
                    ...
                    <div className="flex justify-between items-center">
                        {[
                            ...
                            <button
                                key={tab.key}
                                className={`text-base font-normal ${activeTab === tab.key ? "text-black" : "text-gray-500"}`}
