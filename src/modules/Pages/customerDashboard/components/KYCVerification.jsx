  ...
  return (
    <div className="rounded-lg">
      ...
      <div className="flex gap-4">
        <button className="px-6 py-3 rounded-lg bg-gray-300 text-gray-600 cursor-not-allowed">
          Save Draft
        </button>
        <button type="submit" className="px-6 py-3 cursor-pointer rounded-lg bg-gradient text-white">
          Submit KYC
        </button>
      </div>
    </div>
