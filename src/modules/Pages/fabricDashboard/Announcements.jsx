...
import { FaBullhorn, FaCalendarAlt, FaClock, FaEye, FaArrowLeft, FaStore } from "react-icons/fa";
...
const FabricAnnouncementsPage = () => {
    ...
    const {
        ...
        error,
        refetch
    } = useGetAnnouncements("fabric-vendor");

    // Console log the full response to understand the structure
    console.log("Fabric Vendor Announcements - Full Response:", announcementsData);
    console.log("Fabric Vendor Announcements - Data:", announcementsData?.data);
    console.log("Fabric Vendor Announcements - Nested Data:", announcementsData?.data?.data);
            ...
            <div className="min-h-screen bg-gray-50 p-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <button
                        ...
                        className="flex items-center space-x-2 text-green-600 hover:text-green-700 mb-6 group"
                    >
                ...
                <div className="mb-8">
                    <div className="flex items-center space-x-3 mb-2">
                        <div className="p-2 bg-green-100 rounded-lg">
                            <FaBullhorn className="h-6 w-6 text-green-600" />
                        </div>
                        <h1 className="text-3xl font-bold text-gray-900">Vendor Announcements</h1>
                    </div>
                    <p className="text-gray-600">Important updates and information for fabric vendors.</p>
                </div>
                ...
                {!isLoading && announcements.length === 0 && (
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                        ...
                        <p className="text-gray-600">
                            You're all caught up! New vendor announcements will appear here when available.
                        </p>
                    </div>
                )}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="flex-shrink-0 ml-4">
                                                <div className="p-2 text-gray-400 group-hover:text-green-600 group-hover:bg-green-50 rounded-lg transition-colors">
...
export default FabricAnnouncementsPage;
