export default function Filters({ filters, setFilters }) {
    const categories = [
        "Agbada", "Kaftan", "Bubu", "Hats and Caps", "Suits", "Jumpsuits", "Dress Gowns", "Fabrics"
    ];

    const colors = [
        "Purple", "Black", "Red", "Orange", "Navy", "White", "Brown", "Green", "Yellow", "Grey", "Pink", "Blue"
    ];
    ...
    const marketplaces = [
        "Onitsha Main Market", "Balogun Market", "Kanti Kwari Market", "Wuse Market", "Gbagi Market", "Aba Market", "Oja Oba Market", "Kurmi Market", "Idumota Market", "Ogbete Market"
    ];

    return (
        <div className="bg-white p-3 sm:p-4 rounded-lg w-full">
            <h2 className="text-base sm:text-lg font-semibold mb-4 sm:mb-5">Filter</h2>
            ...
            <div className="mb-3 sm:mb-4">
                ...
                <input
                    ...
                    onChange={(e) => setFilters({ ...filters, price: [parseInt(e.target.value), filters.price[1]] })}
                    className="w-full mb-3"
                />
                <input
                    type="range"
                    min={filters.price[0]} max="200000"
                    ...
                    {sizes.map((size, index) => (
                        <button
                            ...
                            className={`p-3 sm:p-4 rounded text-sm sm:text-base transition ${
                                filters.size === size ? 'bg-purple-600 text-white' : 'bg-gray-100 hover:bg-gray-200'
                            }`}
