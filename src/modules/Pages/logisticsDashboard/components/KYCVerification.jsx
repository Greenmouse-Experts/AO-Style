      ...
      <form action="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select className="w-full p-4 border border-gray-300 rounded-md mb-6" required>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-10">
          ...
          <button type="submit" className="w-full sm:w-auto px-6 py-3 rounded-lg bg-gradient text-white cursor-pointer">
            Submit KYC
          </button>
        </div>
      </form>
