        ...
        { label: "Price", key: "price" },
        {
            ...
            render: (_, row) => (
                <div className="relative flex gap-2" ref={dropdownRef}>
                    <button className="bg-red-100 text-red-500 px-3 py-1 rounded-md"><FaTimes /></button>
                    <button className="bg-green-100 text-green-500 px-3 py-1 rounded-md"><FaCheck /></button>
                    <button className="bg-gray-100 text-gray-500 px-3 py-1 rounded-md" onClick={() => toggleDropdown(row.id)}>
                        <FaEllipsisH />
                    </button>
                    {openDropdown === row.id && (
