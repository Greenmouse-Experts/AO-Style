    ...
    return (
        <div className="">
            <div className="bg-white px-6 py-4 mb-6 relative">
                <h1 className="text-2xl font-medium mb-3">Add Tailor/Fashion Designers</h1>
                <p className="text-gray-500"><Link to="/sales" className="text-blue-500 hover:underline">Dashboard</Link> &gt; Fabric Vendors &gt; Fashion Designers</p>
            </div>
                        ...
                        <div className="mt-4 flex gap-4">
                            <div className="w-1/2 relative">
                                ...
                                <input
                                    ...
                                    className="w-full p-4 border border-[#CCCCCC] outline-none rounded-lg"
                                />
                                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-14 text-gray-400">
                            ...
                            <div className="w-1/2 relative">
                                ...
                                <input
                                    ...
                                    className="w-full p-4 border border-[#CCCCCC] outline-none rounded-lg"
                                />
                                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-14 text-gray-400">
                                    {showConfirmPassword ? <EyeOff size={18} /> : <Eye size={18} />}
                                </button>
                            </div>
                        </div>

                        <button onClick={() => setStep(2)} className="mt-6 px-6 bg-gradient text-white py-4  cursor-pointer rounded-md">
                ...
                {step === 2 && (
                    <div className="p-4">
                        ...
                        <div className="flex justify-between mt-6">
                            <button onClick={() => setStep(1)} className="bg-gray-300 text-gray-700 px-6 py-4 rounded-md">
                                Back
                            </button>
                            <button onClick={() => setStep(3)} className="bg-gradient text-white px-6 py-4 rounded-md">
                                Proceed to KYC
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="p-4">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="w-full p-4 border border-[#CCCCCC] outline-none rounded-lg flex flex-col items-center">
                                    ...
                                    <label htmlFor="idFront" className="cursor-pointer flex items-center space-x-2">
                                        <span>⬆️</span> <span>Upload Front</span>
                                    </label>
                                </div>
                                <div className="w-full p-4 border border-[#CCCCCC] outline-none rounded-lg flex flex-col items-center">
                                    <input type="file" name="idBack" onChange={handleFileChange} className="hidden" id="idBack" />
                                    <label htmlFor="idBack" className="cursor-pointer flex items-center space-x-2">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="w-full p-4 border border-[#CCCCCC] outline-none rounded-lg flex flex-col items-center">
                                ...
                                <label htmlFor="utilityBill" className="cursor-pointer flex items-center space-x-2">
                        ...
                        {/* Navigation Buttons */}
                        <div className="flex justify-between mt-6">
                            <button onClick={() => setStep(2)} className="bg-gray-300 text-gray-700 px-6 py-4 rounded-md">
                                Back
                            </button>
