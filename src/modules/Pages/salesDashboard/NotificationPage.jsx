        ...
        <div className="">
            <div className="bg-white px-6 py-4 mb-6">
                ...
                <p className="text-gray-500">
                    <Link to="/logistics" className="text-blue-500 hover:underline">Dashboard</Link> &gt; Notifications
                </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg">
                <div className="flex flex-wrap justify-between items-center pb-3 mb-4 gap-4">
                    <div className="flex flex-wrap space-x-6 text-gray-600 text-sm font-medium">
                        ...
                        <button onClick={() => setFilter("read")} className={`font-medium ${filter === "read" ? "text-[#A14DF6] border-b-2 border-[#A14DF6]" : "text-gray-500"}`}>
                            All Read (30)
                        </button>
                        <button onClick={() => setFilter("unread")} className={`font-medium ${filter === "unread" ? "text-[#A14DF6] border-b-2 border-[#A14DF6]" : "text-gray-500"}`}>
                            All Unread (60)
                        </button>
                    </div>
                ...
                <div>
                    {filteredNotifications.map((notification) => (
                        <div key={notification.id} className={`flex flex-wrap items-center p-5 gap-3 ${notification.unread ? "bg-purple-100" : ""}`}>
                            <img src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1741985895/AoStyle/image_cuxdyt.png" className="w-14 h-14" alt="icon" />
                            ...
                            {notification.unread && <span className="ml-2 h-2 w-2 bg-[#A14DF6] rounded-full"></span>}
                        </div>
                    ))}
                </div>
            </div>
