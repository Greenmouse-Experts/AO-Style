            ...
            <div className="bg-white p-6 rounded-lg max-w-2xl">
                ...
                <div className="space-y-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer">
                                    ...
                                    <p className="text-xs mb-2">Front Side Style<br />(Less than 5MB)</p>
                                    <input
                                        type="file"
                                        accept="image/*"
                                    ...
                                    />
                                    {stylePhotos.front && (
                                        <p className="text-xs text-gray-500 mt-2">{stylePhotos.front.name}</p>
                                    )}
                                </div>
                                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer">
                                    <UploadCloud className="mx-auto text-gray-400 mb-4" size={32} />
                                    <p className="text-xs mb-2">Back Side Style<br />(Less than 5MB)</p>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        className="mt-2 w-full"
                                    ...
                                    />
                                    {stylePhotos.back && (
                                        <p className="text-xs text-gray-500 mt-2">{stylePhotos.back.name}</p>
                                    )}
                                </div>
                                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer">
                                    <UploadCloud className="mx-auto text-gray-400 mb-4" size={32} />
                                    <p className="text-xs mb-2">Right Side Style<br />(Less than 5MB)</p>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        className="mt-2 w-full"
                                    ...
                                    />
                                    {stylePhotos.right && (
                                        <p className="text-xs text-gray-500 mt-2">{stylePhotos.right.name}</p>
                                    )}
                                </div>
                                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer">
                                    <UploadCloud className="mx-auto text-gray-400 mb-4" size={32} />
                                    <p className="text-xs mb-2">Left Side Style<br />(Less than 5MB)</p>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        className="mt-2 w-full"
                                    ...
                                    />
                                    {stylePhotos.left && (
                                        <p className="text-xs text-gray-500 mt-2">{stylePhotos.left.name}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Video Upload */}
                        <div>
                            <label className="block text-gray-700 mb-4 mt-4">Upload a video of the style (max length of 10secs)</label>
                            <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer">
                                <UploadCloud className="mx-auto text-gray-400 mb-4" size={32} />
                                ...
                                />
                                {styleVideo && (
                                    <p className="text-xs text-gray-500 mt-2">{styleVideo.name}</p>
                                )}
                            </div>
                        </div>
                        ...
                        {/* Tags */}
                        <div>
                            <label className="block text-gray-700 mb-4 mt-4">Tags (max 5)</label>
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <span className="border border-gray-300 rounded-lg px-3 py-2 bg-gray-100 text-gray-700">NGN</span>
                                <input
                                    type="number"
