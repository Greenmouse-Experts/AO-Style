...
const TailorAnnouncementsPage = () => {
  ...
  // Fetch announcements for tailor role with user profile integration
  const {
  ...
  } = useGetAnnouncementsWithProfile("fashion-designer");
  ...
  console.log("Tailor Announcements - Is Loading:", isLoading);
  console.log("Tailor Announcements - Error:", error);
  console.log("Tailor Announcements - Profile Data:", profileData);
  console.log(
    "Tailor Announcements - Profile Created At:",
