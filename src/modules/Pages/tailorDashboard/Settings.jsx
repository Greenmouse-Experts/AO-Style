                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-2 gap-4 p-4 bg-blue-50 border border-blue-100 rounded-lg">
                          ...
                          <div className="col-span-2">
                            <p className="text-xs text-blue-600">
                              📍 Coordinates set automatically from Google
                              Places.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="pt-2">
                        <button
                          ...
                          type="submit"
                          className="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-medium transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                        >
