            ...
            <div className="fixed inset-0 flex justify-center items-center z-50 backdrop-blur-sm">
                <div className="bg-white p-6 rounded-lg w-full sm:w-[500px]">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button onClick={onClose} className="text-gray-500 hover:text-black rounded-full bg-gray-100 p-2">
                            ✕
                        </button>
                    </div>

                    <p className="text-base mb-6 text-start">Fill in form to process your withdrawal</p>
                        ...
                        <form action="">
                            <div>
                                ...
                                <div className="flex justify-end mt-1">
                                    <span className="text-purple-500">Available Amount : N200,000</span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="border border-purple-300 rounded-lg p-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div>
                                            <input type="radio" className="w-5 h-5 text-purple-600" checked  required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type='submit' className="w-full py-4 mt-6 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-medium">
                                Withdraw
                            </button>
                        </form>
                    </div>
